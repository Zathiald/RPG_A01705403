    ...
    if int(len(anillos)) == 0 and int(len(medallons)) == 0 and int(len(cascos)) == 0 and int(len(manzanas)) == 0 and int(len(espadas)) == 0 and int(len(pocions)) == 0 and int(len(botas)) == 0 and int(len(martillos)) == 0 and int(len(super_pocions)) == 0 and int(len(brazaletes)) == 0 and int(len(peluches)) == 0 and int(len(sombreros)) == 0 and int(len(aks)) == 0 and int(len(granadas)) == 0 and int(len(cangureras)) == 0 and int(len(afros)) == 0 and int(len(rayos)) == 0:
        ...
        if obj_inv == "A" or obj_inv == "a":
            if int(len(anillos)) <= 0:
                text_n_a = (
                    "Ya no tienes aniilos disponibles,escoge algo más\n")
                text(text_n_a, 0.03)
                texto_inve()
                obj_inv = str(input())
        ...
        if obj_inv == "M" or obj_inv == "m":
            if int(len(medallons)) == 0:
                text_n_m = (
                    "Ya no tienes medallones disponibles,escoge algo más\n")
                text(text_n_m, 0.03)
                texto_inve()
                obj_inv = str(input())
        ...
        if obj_inv == "C" or obj_inv == "c":
            if int(len(cascos)) <= 0:
                text_n_c = (
                    "Ya no tienes cascos disponibles,escoge algo más\n")
                text(text_n_c, 0.03)
                texto_inve()
                obj_inv = str(input())
        ...
        if obj_inv == "W" or obj_inv == "w":
            if int(len(manzanas)) <= 0:
                text_n_ma = (
                    "Ya no tienes manzanas disponibles,escoge algo más\n")
                text(text_n_ma, 0.03)
                texto_inve()
                obj_inv = str(input())
...
# ------OBJ NIVEL 1
        ...
        if int(len(pocions)) > 0 and obj_inv == "P" or obj_inv == "p":
            if int(len(pocions)) <= 0:
                text_n_p = (
                    "Ya no tienes pociones disponibles,escoge algo más\n")
                text(text_n_p, 0.03)
                texto_inve()
                obj_inv = str(input())
...
# -----------OBJ NIVEL 2
        ...
        if int(len(super_pocions)) > 0 and (obj_inv == "SP" or obj_inv == "sp"):
            if int(len(super_pocions)) <= 0:
                ...
                text_cinv = (
                    "Has usado una super poción, has obtenido 5 de vida\n")
                text(text_cinv, 0.03)
                vida = vida + 5
...
# ----------OBJ NIVEL 3
        if int(len(peluches)) == 1 and obj_inv == "PE" or obj_inv == "pe":
            text_pel = (
                "Es un peluche bonito, pero no puedes hacer mucho con el\n")
            text(text_pel, 0.03)
            texto_inve()
            obj_inv = str(input())
...
# -----------OBJ NIVEL 4
        ...
        if int(len(afros)) == 1 and (obj_inv == "AF" or obj_inv == "af"):
            if int(len(afros)) <= 0:
                text_n_sp = (
                    "Ya no tienes afros disponibles,escoge algo más\n")
                text(text_n_sp, 0.03)
                texto_inve()
                obj_inv = str(input())
                ...
                text_cinv = (
                    "Te has puesto un afro, has obtenido 12 de vida\n")
                text(text_cinv, 0.03)
                vida = vida + 12
                afros.remove("1")
                stats()
...
def obj():
    ...
    if obj == 0:
        text_anillopoder = (
            "¡HAS ENCONTRADO UN ANILLO DE PODER!, usalo con sabiduría\n")
    ...
    def op_tien_1():
        ...
        if op_store == "EF" or op_store == "ef":
            if int(len(espadas)) == 1:
                ...
                text_esp_inv = (
                    "La espada poderosa se ha agregado a tu inventario\n")
        ...
        if op_store == "BF" or op_store == "bf":
            if int(len(botas)) == 1:
                ...
                text_b_inv = (
                    "Las botas flameantes se han agregado a tu inventario\n")
    ...
    def op_tien_2():
        ...
        if op_store == "MT" or op_store == "mt":
            if int(len(martillos)) == 1:
                ...
                text_esp_inv = (
                    "El martillo de trueno se ha agregado a tu inventario\n")
                text(text_esp_inv, 0.03)
                martillos.append("1")
                dinero = dinero - 15
                op_tien_2()
        ...
        if op_store == "SP" or op_store == "sp":
            if int(len(super_pocions)) == 3:
                text_p_full = (
                    "Ya tienes suficiente super pociones no crees?\n")
                text(text_p_full, 0.03)
                op_tien_2()
        ...
        while dinero > 0:
            ...
            if op_store == "PE" or op_store == "pe":
                if int(len(peluches)) == 1:
                    ...
                    text_esp_inv = (
                        "El peluche se ha agregado a tu inventario\n")
                    text(text_esp_inv, 0.03)
                    peluches.append("1")
                    dinero = dinero - 20
                    op_tien_3()
            ...
            if op_store == "SO" or op_store == "so":
                if int(len(sombreros)) == 3:
                    text_p_full = (
                        "Ya tienes suficientes sombreros no crees?\n")
                    text(text_p_full, 0.03)
                    op_tien_3()
