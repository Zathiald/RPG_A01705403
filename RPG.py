...
exp = 7.0 #Se guarda la experiencia
...
#----------OBJ NIVEL 3
                ...
                if int(len(sombreros))>0 and (obj_inv=="S" or obj_inv=="s"):
                    if int(len(sombreros))<=0:
                        text_n_sp=("Ya no tienes sombreros disponibles,escoge algo más\n")
                        text(text_n_sp,0.03)
                        continue
                    else:
                        if nivel==1 and vida>20:
                            ...
                            text_cinv=("Te has puesto un sombrero, has obtenido 7 de vida\n")
                            text(text_cinv,0.03)
                            vida=vida+7
                ...
                if int(len(aks))==1 and obj_inv=="A" or obj_inv=="a":         
                    text_a=("G - Guardar\n")
                    text(text_a,0.03)
                    text_m=("A - Agarrrar\n")
                    text(text_m,0.03)
